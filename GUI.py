...
class Window(Frame):
    def __init__(self, master=None):
        ...
        self.startButton = Button(f1, text="start", command=self.start)
        self.startButton.place(x=350, y=55)
        self.clearButton = Button(f1, text="clear", command=lambda: self.result.delete(1.0, END))
        self.clearButton.place(x=380, y=55)
        self.quitButton = Button(f1, text="quit", command=exit)

...
def parse_args():
    ...
    parser.add_argument("-r", "--restart-policy", type=str, choices=["MLR"],
                        help="specify the restart policy, default to be None", default=
                        None
                        # "MLR"
                        )
    parser.add_argument("-p", "--preprocess-policy", type=str, choices=["NiVER", "lighter-NiVER", "li-NiVER-withPLE"],
                        help="specify the preprocess policy, default to be None", default=
                        None
                        # "NiVER"
                        # "lighter-NiVER"
                        # "li-NiVER-withPLE"
    ...
    parser.add_argument("-b", "--bandit", type=str, choices=["UCB"],
                        help="specify the heuristic changing policy, default to be None", default=
                        None
                        # "UCB"
                        )
